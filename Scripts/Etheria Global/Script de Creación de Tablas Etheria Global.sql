--Script de creación de tablas para Etheria Global (versión final)
-- Activar extensión para UUIDs
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

/* ======================================================
   1. TABLAS DE SEGURIDAD Y PERSONAS
   ====================================================== */
...
CREATE TABLE personas (
    ...
    telefono VARCHAR(20),
    actualizadoPor INT, -- NULL inicial para el primer Admin
    computadoraId INT,
    deleted BOOLEAN DEFAULT FALSE,
    CONSTRAINT fk_personas_actualizado FOREIGN KEY (actualizadoPor) REFERENCES personas(personaId)
);
...
CREATE TABLE exchangeRates (
    ...
    monedaOrigenId INT REFERENCES monedas(monedaId),
    monedaDestinoId INT REFERENCES monedas(monedaId),
...
CREATE TABLE ciudades (
    ...
    provinciaEstadoId INT REFERENCES provinciasEstados(provinciaEstadoId),
    nombre VARCHAR(100) NOT NULL,
    actualizadoPor INT REFERENCES personas(personaId),
    computadoraId INT,
    deleted BOOLEAN DEFAULT FALSE
...
CREATE TABLE ordenesCompra (
    ...
    estado VARCHAR(20), -- 'Pendiente', 'En Transito', etc.
...
CREATE TABLE inventarioHub (
    ...
    loteId INT REFERENCES lotesImportacion(loteId),
...
CREATE TABLE transaccionesCostos (
    ...
    montoOriginal NUMERIC(15,2) NOT NULL,
    tipoCambio NUMERIC(12,6),
    montoCalculado NUMERIC(15,2),
...
/* ======================================================
   6. MARCAS BLANCAS Y TRAZABILIDAD SALIDA
   ====================================================== */
...
CREATE TABLE trazabilidadMovimientos (
    ...
    inventarioId INT REFERENCES inventarioHub(inventarioId),
    ordenIdExterna INT, -- ID de Dynamic Brands
    marcaId INT REFERENCES marcasBlancas(marcaId),
    courierId VARCHAR(100),
    paisDestinoId INT REFERENCES paises(paisId),
    tipoMovimiento VARCHAR(50), -- 'Etiquetado', 'Despacho', etc.
